...
public class OrderFoodController {
    ...
    // Method to populate the menu table with data from the database
//    private void populateMenuTable() {
//        try {
//            menuTable.getItems().clear();
//            menuTable.getItems().addAll(GuestDbhandler.getMenuItems());
//        } catch (SQLException e) {
//            e.printStackTrace();
//            showAlert(Alert.AlertType.ERROR, "Error", "Failed to load menu.");
//        }
//    }
    ...
    // Initialize the controller by populating the menu table
//    @FXML
